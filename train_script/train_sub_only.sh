...
nohup python -u main.py \
    ...
    --train_data ./data/NLPCC/nlpcc/train_only_substitution_augment_1.txt \
    ...
    --l2_lambda 1e-5 \
    --training_max_len 64 > ./logs/train.nlpcc.sub.only.log 2>&1&
...
nohup python -u evaluation_test.py \
    ...
    --l2_lambda 1e-5 \
    --training_max_len 64 \
    --restore_ckpt_path /home/works/yumenghsuan/CGEC/code/TtT/ckpt/NLPCC_sub_only/epoch_28 \
    --test_data ./data/NLPCC/nlpcc/test_sep_insert.txt > ./logs/test.nlpcc.sub.only.log 2>&1&