...
nohup python -u evaluation_test.py \
    ...
    --l2_lambda 1e-5 \
    --training_max_len 64 \
    --restore_ckpt_path /home/works/yumenghsuan/CGEC/code/TtT/ckpt/NLPCC_all_with_distribution/epoch_29 \
    --test_data ./data/NLPCC/nlpcc/test.txt > ./logs/train.nlpcc.all.with.distribution.log 2>&1&
