...
nohup python -u main.py \
    ...
    --train_data ./data/NLPCC/nlpcc/train_all_type_average_augment_1.txt \
...
nohup python -u evaluation_test.py \
    ...
    --l2_lambda 1e-5 \
    --training_max_len 64 \
    --restore_ckpt_path /home/works/yumenghsuan/CGEC/code/TtT/ckpt/NLPCC_all_with_average/epoch_29 \
    --test_data ./data/NLPCC/nlpcc/test.txt > ./logs/test.nlpcc.all.with.average.log 2>&1&
