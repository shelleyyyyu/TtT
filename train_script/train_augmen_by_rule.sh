...
nohup python -u evaluation_test.py \
    ...
    --augment_method $augment_method \
    --augment_descending \
    --restore_ckpt_path /data/yumenghsuan/cgec/ckpt/NLPCC_augment_0.1_contributed_by_rule_/epoch_22_dev_f1_0.538\
    --test_data /data/yumenghsuan/cgec_data/nlpcc/test.txt > ./logs/test.nlpcc.$suffix.log 2>&1&